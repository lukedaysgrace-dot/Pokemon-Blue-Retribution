...
; values for MapSpriteSets and SplitMapSpriteSets (see data/maps/sprite_sets.asm)
	...
	const SPRITESET_ROUTE_3_4_NEW   ; 0f
	const SPRITESET_ROUTE_6_9_NEW   ; 10
	const SPRITESET_ROUTE_8_NEW     ; 11
	const SPRITESET_ROUTE_10_NEW    ; 12
	const SPRITESET_ROUTE_11_NEW    ; 13
	const SPRITESET_ROUTE_12_NEW    ; 14
	const SPRITESET_ROUTE_13_15_NEW ; 15
	const SPRITESET_ROUTE_16_17_NEW ; 16
	const SPRITESET_ROUTE_19_20_NEW ; 17
	const SPRITESET_ROUTE_21_NEW    ; 18
	const SPRITESET_ROUTE_24_25_NEW ; 19
