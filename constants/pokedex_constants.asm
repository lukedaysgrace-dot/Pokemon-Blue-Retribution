...
; - MonPartyData (see data/pokemon/menu_icons.asm; one icon id per National Dex #, order DEX_BULBASAUR..)
; - MonsterPalettes (see data/pokemon/palettes.asm)
	...
	const DEX_SCRAFTY      ; 161
	const DEX_MURKROW    ; 162
	const DEX_HONCHKROW  ; 163
	const DEX_MISDREAVUS ; 164
	const DEX_MISMAGIUS  ; 165
	const DEX_CHINCHOU   ; 166
	const DEX_LANTURN    ; 167
	const DEX_GOROCHU    ; 168
	const DEX_LARVITAR   ; 169
	const DEX_PUPITAR    ; 170
	const DEX_TYRANITAR  ; 171
	const DEX_RALTS      ; 172
	const DEX_KIRLIA     ; 173
	const DEX_GARDEVOIR  ; 174
	const DEX_RIOLU      ; 175
	const DEX_LUCARIO    ; 176
	const DEX_BAGON      ; 177
	const DEX_SHELGON    ; 178
	const DEX_SALAMENCE  ; 179
	const DEX_DUSKULL    ; 180
	const DEX_DUSCLOPS   ; 181
	const DEX_DUSKNOIR   ; 182
	const DEX_GOLETT     ; 183
	const DEX_GOLURK     ; 184
	const DEX_HERACROSS  ; 185
	const DEX_ESPEON     ; 186
	const DEX_UMBREON    ; 187
	const DEX_GLACEON    ; 188
	const DEX_LEAFEON    ; 189
	const DEX_ANNIHILAPE ; 190
	const DEX_BLISSEY    ; 191
	const DEX_CROBAT     ; 192
	const DEX_ELECTIVIRE ; 193
	const DEX_KINGDRA    ; 194
	const DEX_MIMIKYU    ; 195
	const DEX_MAGMORTAR  ; 196
	const DEX_MAGNEZONE  ; 197
	const DEX_DRILBUR    ; 198
	const DEX_EXCADRILL  ; 199
	const DEX_RHYPERIOR  ; 200
	const DEX_SCIZOR     ; 201
	const DEX_STEELIX    ; 202
	const DEX_TANGROWTH  ; 203
	const DEX_VENIPEDE   ; 204
	const DEX_WHIRLIPEDE ; 205
	const DEX_SCOLIPEDE  ; 206
	const DEX_SNEASEL    ; 207
	const DEX_WEAVILE    ; 208
	const DEX_MESMERIA   ; 209
	const DEX_SNORUNT    ; 210
	const DEX_FROSLASS   ; 211
	const DEX_PHANPY     ; 212
	const DEX_DONPHAN    ; 213
	const DEX_HOUNDOUR   ; 214
	const DEX_HOUNDOOM   ; 215
	const DEX_CRANIDOS   ; 216
	const DEX_RAMPARDOS  ; 217
	const DEX_SHIELDON   ; 218
	const DEX_BASTIODON  ; 219
	const DEX_MAREEP     ; 220
	const DEX_FLAAFFY    ; 221
	const DEX_AMPHAROS   ; 222
