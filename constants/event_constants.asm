...
; Viridian City events
	...
	const EVENT_VIRIDIAN_FISHER_GAVE_ROD
	const_skip 21
...
; Pewter City events
	...
	const EVENT_GOT_AXEW_IN_MUSEUM
	const_skip 7
...
; Cerulean City events
	...
	const EVENT_GOT_PORYGON2_IN_BIKE_SHOP
	const EVENT_MET_CERULEAN_FOSSIL_SCIENTIST
	const_skip 11
...
; Vermilion City events
	...
	const EVENT_GOT_DEINO_IN_TRADE_HOUSE
	const_skip 2
...
; Fuchsia City events
	...
	const EVENT_FUCHSIA_JANINE_REVEALED
...
; Route 10 events
	...
	const EVENT_BEAT_ROUTE_10_GREEN
	const_skip 1
...
; Route 13 events
	...
	const EVENT_BEAT_ROUTE13_MEW
	const EVENT_FIGHT_ROUTE13_MEW
...
; Mt. Moon events
	...
	const EVENT_GOT_MT_MOON_SUPER_NERD_FOSSIL
	const EVENT_MT_MOON_SUPER_NERD_FOUR_FOSSIL_TOLD
	const EVENT_MT_MOON_SUPER_NERD_SELL_WARNING
...
; Rocket Hideout events
	...
	const EVENT_BEAT_ROCKET_HIDEOUT_B2F_GREEN
	const_skip 14
...
; Silph Co. events
	...
	const EVENT_BEAT_SILPH_CO_2F_TRAINER_4
	const EVENT_BEAT_SILPH_CO_2F_TRAINER_5
	const_skip 5
	...
	const EVENT_BEAT_SILPH_CO_3F_TRAINER_2
	const EVENT_BEAT_SILPH_CO_3F_TRAINER_3
	const_skip 4
...
DEF INDIGO_PLATEAU_EVENTS_START EQU const_value
	...
	const EVENT_HEARD_CHAMPION_RIVAL_POST_LOSS_DIALOGUE
	const EVENT_BEAT_INDIGO_PLATEAU_GREEN
	const_skip 3
	const_skip
...
; Postgame: set when each rematch is won (gates Pallet final rival)
	...
	const EVENT_REMATCH_DEFEATED_ERIKA
	const EVENT_REMATCH_DEFEATED_KOGA
	const EVENT_REMATCH_DEFEATED_BLAINE
	const EVENT_REMATCH_DEFEATED_SABRINA
	const EVENT_REMATCH_DEFEATED_GIOVANNI
	const EVENT_REMATCH_DEFEATED_LORELEI
	const EVENT_REMATCH_DEFEATED_BRUNO
	const EVENT_REMATCH_DEFEATED_AGATHA
	const EVENT_REMATCH_DEFEATED_LANCE
	const EVENT_REMATCH_DEFEATED_RIVAL_CHAMPION
	const EVENT_BEAT_VIRIDIAN_BLUE_CLOAK
	const EVENT_BEAT_PALLET_TOWN_GREEN
	const EVENT_BEAT_ROUTE1_OAK

DEF EVENT_BEAT_KARENS_ROOM_TRAINER_0 EQU EVENT_BEAT_BRUNOS_ROOM_TRAINER_0
DEF EVENT_AUTOWALKED_INTO_KARENS_ROOM EQU EVENT_AUTOWALKED_INTO_BRUNOS_ROOM
DEF EVENT_REMATCH_DEFEATED_KAREN EQU EVENT_REMATCH_DEFEATED_BRUNO
