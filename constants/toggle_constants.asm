...
; after battle and are detected in wToggleableObjectList.)
	...
	const TOGGLE_SAFARI_ZONE_EAST_ITEM_1       ; C4 X
	const TOGGLE_SAFARI_ZONE_EAST_ITEM_2       ; C5 X
	const TOGGLE_SAFARI_ZONE_EAST_ITEM_3       ; C6 X
	const TOGGLE_SAFARI_ZONE_EAST_ITEM_4       ; C7 X
