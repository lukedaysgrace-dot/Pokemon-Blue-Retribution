...
SpritePaletteAssignments: ; Characters on the overworld
	...
	; 0x7b: SPRITE_YOUNGSTER_NEW
	db SPR_PAL_BLUE

	; 0x7c: SPRITE_BUG_CATCHER_NEW
	db SPR_PAL_BLUE

	; 0x7d: SPRITE_LASS_NEW
	db SPR_PAL_PURPLE

	; 0x7e: SPRITE_JR_TRAINER_M_NEW
	db SPR_PAL_GREEN

	; 0x7f: SPRITE_JR_TRAINER_F_NEW
	db SPR_PAL_GREEN

	; 0x80: SPRITE_POKEMANIAC_NEW
	db SPR_PAL_PURPLE

	; 0x81: SPRITE_SUPER_NERD_NEW
	db SPR_PAL_BROWN

	; 0x82: SPRITE_HIKER_NEW
	db SPR_PAL_PURPLE

	; 0x83: SPRITE_BURGLAR_NEW
	db SPR_PAL_PURPLE

	; 0x84: SPRITE_ENGINEER_NEW
	db SPR_PAL_ORANGE

	; 0x85: SPRITE_FISHER_NEW
	db SPR_PAL_BLUE

	; 0x86: SPRITE_SWIMMER_NEW
	db SPR_PAL_BLUE

	; 0x87: SPRITE_CUE_BALL_NEW
	db SPR_PAL_BLUE

	; 0x88: SPRITE_ROCKER_NEW
	db SPR_PAL_ORANGE

	; 0x89: SPRITE_JUGGLER_NEW
	db SPR_PAL_ORANGE

	; 0x8a: SPRITE_TAMER_NEW
	db SPR_PAL_BLUE

	; 0x8b: SPRITE_BIRD_KEEPER_NEW
	db SPR_PAL_BLUE
