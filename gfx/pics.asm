...
; Snorunt/Froslass in their own bank — "Pics 7" was at the $4000 ROM bank limit.
SECTION "Pics 8", ROMX
...
SnoruntPicFront::     INCBIN "gfx/pokemon/front/snorunt.pic"
SnoruntPicBack::      INCBIN "gfx/pokemon/back/snoruntb.pic"
