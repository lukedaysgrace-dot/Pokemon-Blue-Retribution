...
; if A is pressed
	...
	and a
	jr z, OverworldLoop ; jump if a hidden event or bookshelf was found, but not if a card key door was found
	call IsSpriteOrSignInFrontOfPlayer
	ldh a, [hTextID]
	and a
	jr nz, .displayDialogue
	farcall TryFieldHMInteraction
	jp OverworldLoop
.displayDialogue
...
LoadWalkingPlayerSpriteGraphics::
	farjp _LoadWalkingPlayerSpriteGraphics

LoadSurfingPlayerSpriteGraphics::
	farjp _LoadSurfingPlayerSpriteGraphics

LoadBikePlayerSpriteGraphics::
	farjp _LoadBikePlayerSpriteGraphics
