...
DeterminePaletteID:
	ld [wPokedexNum], a
	and a
	; Species 0 is used before the first mon is sent out (e.g. trainer pics).
	; IndexToPokedex does dec a and would read garbage from PokedexOrder.
	jr z, .trainerPalette
