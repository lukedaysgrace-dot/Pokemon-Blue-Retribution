...
; Load font before showing the window. LoadFontTilePatterns copies 8 tiles per
; VBlank; if hWY is 0 first, the text box shows wrong tiles (sprite chunks) until
; the upload finishes — obvious for field Cut/Surf after FieldHMBeforePrintText.
