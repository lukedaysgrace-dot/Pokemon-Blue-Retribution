...
SetupPokeballs:
	ld a, [de]
; wEnemyPartyCount shares WRAM with wGrassRate — can be the encounter rate (e.g. 25)
; after a wild build until ReadTrainer clears it. Cap so PickPokeball cannot overrun wBuffer / hl.
	cp PARTY_LENGTH + 1
	jr c, .partyCountOk
	ld a, PARTY_LENGTH
.partyCountOk
