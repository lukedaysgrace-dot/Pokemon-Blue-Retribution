...
INCLUDE "data/tilesets/flower_tiles.asm"
...
SECTION "Field HM Interaction", ROMX

INCLUDE "engine/overworld/field_hm_interaction.asm"
...
; Table + ApplyCustomTrainerMoves in bank $2C (same bank: no rROMB switch inside routine).
; ReadTrainer uses farcall (trainer code is in another bank).
SECTION "Custom Trainer Moves Data", ROMX

INCLUDE "data/trainers/custom_trainer_moves_table.asm"
INCLUDE "data/trainers/custom_trainer_moves.asm"

INCLUDE "gfx/green_bank2c.asm"
