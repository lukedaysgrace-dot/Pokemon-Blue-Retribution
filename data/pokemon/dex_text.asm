...
_ElectivireDexEntry::
	text "Its tails channel"
	next "vast voltage and"
	next "stun foes on"
...
_GlaceonDexEntry::
	text "It chills the air"
	next "around itself"
	next "until fine snow"

	page "begins to drift"
	next "down"
	dex
...
_LeafeonDexEntry::
	text "Clean air and sun"
	next "make its leafy"
	next "tail and ears"

	page "smell like fresh"
	next "grass"
	dex
...
_MagmortarDexEntry::
	text "The ends of its"
	next "arms flare like"
	next "cannons before"

	page "it launches hot"
	next "fireballs"
	dex

_MagnezoneDexEntry::
	text "It emits strong"
	next "magnetism that"
	next "can jam machines"
...
_ScolipedeDexEntry::
	text "It can sprint with"
	next "its long body"
	next "while carrying"

	page "smaller allies on"
	next "its back"
	dex
...
_TangrowthDexEntry::
	text "Its body hides"
	next "beneath a tangle"
	next "of vines that"

	page "whip out to grab"
	next "prey"
	dex
...
_WeavileDexEntry::
	text "It moves in quick"
	next "packs and marks"
	next "targets with claw"

	page "scratches before"
	next "striking"
	dex

_WhirlipedeDexEntry::
	text "It tucks in its"
	next "body and rolls"
	next "forward while"

	page "striking foes with"
	next "spines"
	dex

_MesmeriaDexEntry::
	text "It sways and sings"
	next "to entrance foes,"
	next "then freezes them"
