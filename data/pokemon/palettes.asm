...
ELSE
	...
	db PAL_MEWMON    ; MEW
	db PAL_GREENMON  ; DEINO
	db PAL_GREENMON  ; ZWEILOUS
	db PAL_GREENMON  ; HYDREIGON
	db PAL_REDMON    ; AXEW
	db PAL_REDMON    ; FRAXURE
	db PAL_REDMON    ; HAXORUS
	db PAL_CYANMON   ; PORYGON2
	db PAL_CYANMON   ; PORYGONZ
	db PAL_CYANMON   ; SCRAGGY
	db PAL_BLUEMON   ; MURKROW
	db PAL_BLUEMON   ; HONCHKROW
	db PAL_PURPLEMON ; MISDREAVUS
	db PAL_PURPLEMON ; MISMAGIUS
	db PAL_CYANMON   ; CHINCHOU
	db PAL_CYANMON   ; LANTURN
	db PAL_YELLOWMON ; GOROCHU
	db PAL_GREENMON  ; LARVITAR
	db PAL_BLUEMON   ; PUPITAR
	db PAL_GREENMON  ; TYRANITAR
	db PAL_GARDMON   ; RALTS
	db PAL_GARDMON   ; KIRLIA
	db PAL_GARDMON   ; GARDEVOIR
	db PAL_BLUEMON   ; RIOLU
	db PAL_BLUEMON   ; LUCARIO
	db PAL_BLUEMON   ; BAGON
	db PAL_GRAYMON   ; SHELGON
	db PAL_SALAMON   ; SALAMENCE
	db PAL_GRAYMON   ; DUSKULL
	db PAL_GRAYMON   ; DUSCLOPS
	db PAL_GRAYMON   ; DUSKNOIR
	db PAL_GRAYMON   ; GOLETT
	db PAL_GRAYMON   ; GOLURK
	...
	db PAL_GRAYMON   ; MIMIKYU
	db PAL_REDMON    ; MAGMORTAR
	db PAL_GRAYMON   ; MAGNEZONE
	db PAL_GRAYMON   ; DRILBUR
	db PAL_GRAYMON   ; EXCADRILL
	db PAL_GRAYMON   ; RHYPERIOR
	db PAL_REDMON    ; SCIZOR
	db PAL_GRAYMON   ; STEELIX
	db PAL_BLUEMON   ; TANGROWTH
	db PAL_VENMON    ; VENIPEDE
	db PAL_WHIRLMON  ; WHIRLIPEDE
	db PAL_SCOLMON   ; SCOLIPEDE
	db PAL_GRAYMON   ; SNEASEL
	db PAL_GRAYMON   ; WEAVILE
	db PAL_MEWMON    ; MESMERIA
	db PAL_CYANMON   ; SNORUNT
	db PAL_CYANMON   ; FROSLASS
	db PAL_CYANMON   ; PHANPY
	db PAL_GRAYMON   ; DONPHAN
	db PAL_REDMON    ; HOUNDOUR
	db PAL_REDMON    ; HOUNDOOM
	db PAL_BLUEMON   ; CRANIDOS
	db PAL_BLUEMON   ; RAMPARDOS
	db PAL_YELLOWMON ; SHIELDON
	db PAL_YELLOWMON ; BASTIODON
	db PAL_YELLOWMON ; MAREEP
	db PAL_YELLOWMON ; FLAAFFY
	db PAL_YELLOWMON ; AMPHAROS
	db PAL_BLUEMON   ; SCRAFTY
	db PAL_BLUEMON   ; PAWNIARD
	db PAL_BLUEMON   ; BISHARP
	db PAL_CYANMON   ; WIMPOD
	db PAL_CYANMON   ; GOLISOPOD
	db PAL_PURPLEMON ; LILEEP
