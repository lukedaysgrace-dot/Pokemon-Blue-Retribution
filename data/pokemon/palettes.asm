MonsterPalettes:
	...
	db PAL_GRAYMON   ; RIOLU
	db PAL_GRAYMON   ; LUCARIO
	db PAL_BLUEMON   ; BAGON
	db PAL_BLUEMON   ; SHELGON
	db PAL_BLUEMON   ; SALAMENCE
	db PAL_PURPLEMON ; DUSKULL
	db PAL_PURPLEMON ; DUSCLOPS
	db PAL_PURPLEMON ; DUSKNOIR
