...
; --- Ariana - Silph Co. 11F (UNUSED_JUGGLER, wTrainerNo 1) ---
; Arbok L31
db UNUSED_JUGGLER, 1, 1, BITE, GLARE, ACID, WRAP
; Gloom L31
db UNUSED_JUGGLER, 1, 2, ACID, SLEEP_POWDER, STUN_SPORE, MEGA_DRAIN
; Murkrow L32
db UNUSED_JUGGLER, 1, 3, PECK, NIGHT_SHADE, HAZE, WING_ATTACK
; Ninetales L33
db UNUSED_JUGGLER, 1, 4, EMBER, CONFUSE_RAY, FIRE_BLAST, QUICK_ATTACK
