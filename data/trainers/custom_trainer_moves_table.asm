...
; --- Bruno ---
; Onix L53
db KAREN, 1, 1, ROCK_THROW, DIG, SLAM, HARDEN
; Hitmonchan L55
db KAREN, 1, 2, ICE_PUNCH, THUNDERPUNCH, MEGA_PUNCH, COUNTER
; Hitmonlee L55
db KAREN, 1, 3, JUMP_KICK, OUTRAGE, HI_JUMP_KICK, MEGA_KICK
; Onix L56
db KAREN, 1, 4, ROCK_THROW, DIG, SLAM, HARDEN
; Machamp L58
db KAREN, 1, 5, LEER, OUTRAGE, FISSURE, SUBMISSION
ELSE
; --- Karen ---
; Umbreon L46
...
IF DEF(_RED)
; --- Bruno rematch (KAREN/BRUNO, 2) ---
; Steelix L58
db KAREN, 2, 1, ROCK_SLIDE, EARTHQUAKE, SLAM, HARDEN
; Hitmonchan L58
db KAREN, 2, 2, ICE_PUNCH, THUNDERPUNCH, MEGA_PUNCH, COUNTER
; Hitmonlee L58
db KAREN, 2, 3, JUMP_KICK, OUTRAGE, HI_JUMP_KICK, MEGA_KICK
; Rhyperior L58
db KAREN, 2, 4, ROCK_SLIDE, EARTHQUAKE, FISSURE, BODY_SLAM
; Machamp L58
db KAREN, 2, 5, BODY_SLAM, OUTRAGE, FISSURE, SUBMISSION
; Annihilape L58
db KAREN, 2, 6, SHADOW_BALL, OUTRAGE, SUBMISSION, COUNTER
ELSE
...
; --- Prof. Oak — Oak's Lab postgame team (PROF_OAK, wTrainerNo 1) ---
; Tauros L75
db PROF_OAK, 1, 1, BODY_SLAM, EARTHQUAKE, HYPER_BEAM, BLIZZARD
; Dragonite L75
db PROF_OAK, 1, 2, THUNDER_WAVE, THUNDERBOLT, ICE_BEAM, HYPER_BEAM
; Exeggutor L75
db PROF_OAK, 1, 3, PSYCHIC_M, SLEEP_POWDER, EXPLOSION, MEGA_DRAIN
; Cloyster L75
db PROF_OAK, 1, 4, BLIZZARD, SURF, REFLECT, EXPLOSION
; Snorlax L75
db PROF_OAK, 1, 5, BODY_SLAM, REST, HYPER_BEAM, EARTHQUAKE
; Charizard L75
db PROF_OAK, 1, 6, FIRE_BLAST, EARTHQUAKE, SWORDS_DANCE, HYPER_BEAM
