...
; Route 20
	...
	db 30, TENTACRUEL, HORSEA, SEEL, 0
; Rock Tunnel 1F
...
; Route 19
	db 27, POLIWHIRL, GOLDEEN, SEAKING, GOLDEEN, POLIWHIRL, 0
	db 30, GOLDEEN, SEAKING, 0
	db 29, STARYU, STARYU, STARMIE, 0
; Route 20
...
; Fuchsia Gym
	db 33, GLOOM, HAUNTER, VENOMOTH, KOFFING, 0	;db 31, DROWZEE, HYPNO, KADABRA, DROWZEE, 0
	db 38, EXEGGCUTE, EXEGGUTOR, 0	;db 38, HYPNO, 0
...
; Route 13
	...
	db 25, FEAROW, PIDGEOTTO, PIDGEY, FEAROW, SPEAROW, 0
...
; Mansion 3F
	db 33, MAGNEMITE, MAGNETON, LICKITUNG, 0
; Mansion B1F
...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 25, CUBONE, 24, RHYHORN, 28, KABUTO, 29, KANGASKHAN, 0
; Silph Co. 11F
	db $FF, 37, NIDOKING, 37, KANGASKHAN, 37, RHYHORN, 40, KABUTOPS, 41, NIDOQUEEN, 0
; Viridian Gym
	db $FF, 41, KANGASKHAN, 42, MAROWAK, 45, NIDOQUEEN, 43, NIDOKING, 42, RHYDON, 42, KABUTOPS, 0
; Post-Champion rematch (wTrainerNo 4)
	db $FF, 55, RHYPERIOR, 55, NIDOQUEEN, 55, NIDOKING, 55, PERSIAN, 55, MAROWAK, 55, MEWTWO, 0
RocketData:
; Mt. Moon B2F
...
; Silph Co. 10F
	db 33, MACHOKE, 0
; Silph Co. 11F
	db 25, RATTATA, RATTATA, ZUBAT, RATICATE, ARBOK, 0
	db 32, MAROWAK, DROWZEE, MAROWAK, 0
; Unused
...
BrunoData:
	db $FF, 46, STEELIX, 47, HITMONCHAN, 47, HITMONLEE, 47, GOLEM, 50, MACHAMP, 48, POLIWRATH, 0
; Post-Champion rematch (wTrainerNo 2)
	db $FF, 58, MACHAMP, 58, POLIWRATH, 58, HITMONCHAN, 58, GOLEM, 58, STEELIX, 58, ANNIHILAPE, 0
BrockData:
...
; Post-Champion rematch (wTrainerNo 2)
	db $FF, 55, ARCANINE, 55, NINETALES, 55, RAPIDASH, 55, MOLTRES, 55, MAGMAR, 55, FLAREON, 0
SabrinaData:
...
; Route 22
	db $FF, 44, PIDGEOT, 45, RHYHORN, 46, ARCANINE, 46, EXEGGUTOR, 47, ALAKAZAM, 48, BLASTOISE, 0
	db $FF, 44, PIDGEOT, 45, RHYHORN, 46, GYARADOS, 46, ARCANINE, 47, ALAKAZAM, 48, VENUSAUR, 0
	db $FF, 44, PIDGEOT, 45, RHYHORN, 46, EXEGGUTOR, 46, GYARADOS, 47, ALAKAZAM, 48, CHARIZARD, 0
Rival3Data:
	db $FF, 54, PIDGEOT, 57, ALAKAZAM, 55, RHYDON, 56, ARCANINE, 56, EXEGGUTOR, 60, BLASTOISE, 0
	db $FF, 54, PIDGEOT, 57, ALAKAZAM, 55, RHYDON, 56, GYARADOS, 56, ARCANINE, 60, VENUSAUR, 0
...
LoreleiData:
	db $FF, 45, DEWGONG, 46, CLOYSTER, 46, SLOWBRO, 47, MESMERIA, 47, LAPRAS, 46, VAPOREON, 0
; Post-Champion rematch (wTrainerNo 2)
	db $FF, 58, LAPRAS, 58, CLOYSTER, 58, SLOWBRO, 58, MESMERIA, 58, DEWGONG, 58, ARTICUNO, 0
ChannelerData:
; Unused
	db 22, GASTLY, 0
	db 24, GASTLY, 0
...
; Post-Champion rematch (wTrainerNo 2)
	db $FF, 60, GENGAR, 60, GOLBAT, 60, GENGAR, 60, ARBOK, 60, MUK, 60, TENTACRUEL, 0
LanceData:
	db $FF, 52, GYARADOS, 54, DRAGONITE, 54, DRAGONITE, 52, AERODACTYL, 55, DRAGONITE, 54, KINGDRA, 0
; Post-Champion rematch (wTrainerNo 2)
	db $FF, 62, DRAGONITE, 62, DRAGONAIR, 62, CHARIZARD, 62, KINGDRA, 62, AERODACTYL, 62, GYARADOS, 0
