...
Route12_Object:
	...
	object_event 14, 31, SPRITE_FISHER_NEW, STAY, LEFT, TEXT_ROUTE12_FISHER1, OPP_FISHER, 3
	object_event  5, 39, SPRITE_FISHER_NEW, STAY, UP, TEXT_ROUTE12_FISHER2, OPP_FISHER, 4
	object_event 11, 92, SPRITE_JR_TRAINER_M_NEW, STAY, LEFT, TEXT_ROUTE12_COOLTRAINER_M, OPP_JR_TRAINER_M, 9
	object_event 14, 76, SPRITE_ROCKER_NEW, STAY, UP, TEXT_ROUTE12_SUPER_NERD, OPP_ROCKER, 1
	object_event 12, 40, SPRITE_FISHER_NEW, STAY, LEFT, TEXT_ROUTE12_FISHER3, OPP_FISHER, 5
	object_event  9, 52, SPRITE_FISHER_NEW, STAY, RIGHT, TEXT_ROUTE12_FISHER4, OPP_FISHER, 6
	object_event  6, 87, SPRITE_FISHER_NEW, STAY, DOWN, TEXT_ROUTE12_FISHER5, OPP_FISHER, 11
	object_event 14, 35, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE12_TM_PAY_DAY, TM_METAL_CLAW
