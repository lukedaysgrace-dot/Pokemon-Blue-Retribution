	...
	const_export POKEMONMANSIONB1F_GREEN
	const_export POKEMONMANSIONB1F_MEW
	const_export POKEMONMANSIONB1F_BALL
...
PokemonMansionB1F_Object:
	...
	def_object_events
	object_event 16, 23, SPRITE_BURGLAR_NEW, STAY, NONE, TEXT_POKEMONMANSIONB1F_BURGLAR, OPP_BURGLAR, 9
	...
	object_event 16, 20, SPRITE_PAPER, STAY, NONE, TEXT_POKEMONMANSIONB1F_DIARY
	object_event  5, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_SECRET_KEY, SECRET_KEY
	object_event  5,  8, SPRITE_UNUSED_SCIENTIST, STAY, DOWN, TEXT_POKEMONMANSIONB1F_GREEN, OPP_GREEN, 7
