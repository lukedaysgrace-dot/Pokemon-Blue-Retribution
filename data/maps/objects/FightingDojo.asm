...
FightingDojo_Object:
	...
	def_object_events
	object_event  5,  3, SPRITE_BLACKBELT_NEW, STAY, DOWN, TEXT_FIGHTINGDOJO_KARATE_MASTER, OPP_BLACKBELT, 1
	object_event  3,  4, SPRITE_BLACKBELT_NEW, STAY, RIGHT, TEXT_FIGHTINGDOJO_BLACKBELT1, OPP_BLACKBELT, 2
	object_event  3,  6, SPRITE_BLACKBELT_NEW, STAY, RIGHT, TEXT_FIGHTINGDOJO_BLACKBELT2, OPP_BLACKBELT, 3
	object_event  5,  5, SPRITE_BLACKBELT_NEW, STAY, LEFT, TEXT_FIGHTINGDOJO_BLACKBELT3, OPP_BLACKBELT, 4
	object_event  5,  7, SPRITE_BLACKBELT_NEW, STAY, LEFT, TEXT_FIGHTINGDOJO_BLACKBELT4, OPP_BLACKBELT, 5
