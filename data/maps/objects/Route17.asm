...
Route17_Object:
	...
	def_object_events
	object_event 12, 19, SPRITE_CUE_BALL_NEW, STAY, LEFT, TEXT_ROUTE17_BIKER1, OPP_CUE_BALL, 4
	object_event 11, 16, SPRITE_CUE_BALL_NEW, STAY, RIGHT, TEXT_ROUTE17_BIKER2, OPP_CUE_BALL, 5
	...
	object_event 17, 58, SPRITE_CUE_BALL_NEW, STAY, LEFT, TEXT_ROUTE17_BIKER6, OPP_CUE_BALL, 6
	object_event  2, 68, SPRITE_CUE_BALL_NEW, STAY, RIGHT, TEXT_ROUTE17_BIKER7, OPP_CUE_BALL, 7
	object_event 14, 98, SPRITE_CUE_BALL_NEW, STAY, RIGHT, TEXT_ROUTE17_BIKER8, OPP_CUE_BALL, 8
