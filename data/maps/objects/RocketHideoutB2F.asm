	...
	const_export ROCKETHIDEOUTB2F_TM_SHADOW_BALL
	const_export ROCKETHIDEOUTB2F_SUPER_POTION
	const_export ROCKETHIDEOUTB2F_GREEN
...
RocketHideoutB2F_Object:
	...
	def_object_events
	object_event 20, 12, SPRITE_ROCKET_GIRL, STAY, DOWN, TEXT_ROCKETHIDEOUTB2F_ROCKET, OPP_ROCKET_F, 13
	...
	object_event  6, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB2F_TM_SHADOW_BALL, TM_SHADOW_BALL
	object_event  3, 21, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKETHIDEOUTB2F_SUPER_POTION, SUPER_POTION
	object_event 21, 22, SPRITE_GREEN_ROCKET, STAY, NONE, TEXT_ROCKETHIDEOUTB2F_GREEN
