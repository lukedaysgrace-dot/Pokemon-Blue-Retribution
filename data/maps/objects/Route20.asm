...
Route20_Object:
	...
	object_event 55, 14, SPRITE_JR_TRAINER_F_NEW, STAY, RIGHT, TEXT_ROUTE20_SWIMMER4, OPP_JR_TRAINER_F, 24
	...
	object_event 24, 12, SPRITE_JR_TRAINER_F_NEW, STAY, DOWN, TEXT_ROUTE20_SWIMMER8, OPP_JR_TRAINER_F, 16
