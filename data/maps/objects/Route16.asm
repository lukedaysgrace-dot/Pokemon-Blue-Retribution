...
Route16_Object:
	...
	object_event 14, 13, SPRITE_CUE_BALL_NEW, STAY, RIGHT, TEXT_ROUTE16_BIKER2, OPP_CUE_BALL, 1
	object_event 11, 12, SPRITE_CUE_BALL_NEW, STAY, UP, TEXT_ROUTE16_BIKER3, OPP_CUE_BALL, 2
	object_event  9, 11, SPRITE_BIKER, STAY, LEFT, TEXT_ROUTE16_BIKER4, OPP_BIKER, 6
	object_event  6, 10, SPRITE_CUE_BALL_NEW, STAY, RIGHT, TEXT_ROUTE16_BIKER5, OPP_CUE_BALL, 3
