...
Route8_Object:
	...
	def_object_events
	object_event  8,  5, SPRITE_SUPER_NERD_NEW, STAY, RIGHT, TEXT_ROUTE8_SUPER_NERD1, OPP_SUPER_NERD, 3
	object_event 13,  9, SPRITE_GAMBLER, STAY, UP, TEXT_ROUTE8_GAMBLER1, OPP_GAMBLER, 5
	object_event 42,  6, SPRITE_SUPER_NERD_NEW, STAY, UP, TEXT_ROUTE8_SUPER_NERD2, OPP_SUPER_NERD, 4
	object_event 26,  3, SPRITE_LASS_NEW, STAY, LEFT, TEXT_ROUTE8_COOLTRAINER_F1, OPP_LASS, 13
	object_event 26,  4, SPRITE_SUPER_NERD_NEW, STAY, RIGHT, TEXT_ROUTE8_SUPER_NERD3, OPP_SUPER_NERD, 5
	object_event 26,  5, SPRITE_LASS_NEW, STAY, LEFT, TEXT_ROUTE8_COOLTRAINER_F2, OPP_LASS, 14
	object_event 26,  6, SPRITE_LASS_NEW, STAY, RIGHT, TEXT_ROUTE8_COOLTRAINER_F3, OPP_LASS, 15
	object_event 46, 13, SPRITE_GAMBLER, STAY, DOWN, TEXT_ROUTE8_GAMBLER2, OPP_GAMBLER, 7
	object_event 51, 12, SPRITE_LASS_NEW, STAY, LEFT, TEXT_ROUTE8_COOLTRAINER_F4, OPP_LASS, 16
