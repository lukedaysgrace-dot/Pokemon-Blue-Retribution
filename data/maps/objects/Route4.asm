...
Route4_Object:
	...
	object_event 79, 10, SPRITE_LASS_NEW, STAY, DOWN, TEXT_ROUTE4_COOLTRAINER_F2, OPP_LASS, 4
	object_event 57,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE4_TM_PAY_DAY, TM_PAY_DAY
