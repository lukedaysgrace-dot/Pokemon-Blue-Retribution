...
Route4_Object:
	...
	object_event 63,  3, SPRITE_LASS_NEW, STAY, RIGHT, TEXT_ROUTE4_COOLTRAINER_F2, OPP_LASS, 4
	object_event 57,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE4_TM_CRUNCH, TM_CRUNCH
