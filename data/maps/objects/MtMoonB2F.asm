	...
	const_export MTMOONB2F_CLAW_FOSSIL
	const_export MTMOONB2F_TM_MEGA_PUNCH
	const_export MTMOONB2F_SKULL_FOSSIL
...
MtMoonB2F_Object:
	...
	def_object_events
	object_event 12,  8, SPRITE_SUPER_NERD_NEW, STAY, RIGHT, TEXT_MTMOONB2F_SUPER_NERD, OPP_SUPER_NERD, 2
	object_event 11, 16, SPRITE_ROCKET_GIRL, STAY, DOWN, TEXT_MTMOONB2F_ROCKET1, OPP_ROCKET_F, 1
	object_event 15, 22, SPRITE_ROCKET, STAY, DOWN, TEXT_MTMOONB2F_ROCKET2, OPP_ROCKET, 2
	object_event 29, 11, SPRITE_ROCKET_GIRL, STAY, UP, TEXT_MTMOONB2F_ROCKET3, OPP_ROCKET_F, 3
	...
	object_event 28, 21, SPRITE_FOSSIL, STAY, NONE, TEXT_MTMOONB2F_CLAW_FOSSIL, CLAW_FOSSIL
	object_event 29,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_MTMOONB2F_TM_MEGA_PUNCH, TM_MEGA_PUNCH
	object_event 35,  5, SPRITE_FOSSIL, STAY, NONE, TEXT_MTMOONB2F_SKULL_FOSSIL, SKULL_FOSSIL
