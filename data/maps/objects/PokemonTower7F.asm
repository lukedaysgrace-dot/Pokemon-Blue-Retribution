...
PokemonTower7F_Object:
	...
	def_object_events
	object_event  9, 11, SPRITE_ROCKET_GIRL, STAY, RIGHT, TEXT_POKEMONTOWER7F_ROCKET1, OPP_ROCKET_F, 19
	object_event 12,  9, SPRITE_ROCKET, STAY, LEFT, TEXT_POKEMONTOWER7F_ROCKET2, OPP_ROCKET, 20
	object_event  9,  7, SPRITE_ROCKET_GIRL, STAY, RIGHT, TEXT_POKEMONTOWER7F_ROCKET3, OPP_ROCKET_F, 21
