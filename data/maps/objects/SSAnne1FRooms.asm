...
SSAnne1FRooms_Object:
	...
	object_event 11, 14, SPRITE_YOUNGSTER_NEW, STAY, UP, TEXT_SSANNE1FROOMS_YOUNGSTER, OPP_YOUNGSTER, 8
	object_event 13, 11, SPRITE_LASS_NEW, STAY, LEFT, TEXT_SSANNE1FROOMS_COOLTRAINER_F, OPP_LASS, 11
