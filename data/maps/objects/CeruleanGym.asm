...
CeruleanGym_Object:
	...
	object_event  2,  3, SPRITE_JR_TRAINER_F_NEW, STAY, RIGHT, TEXT_CERULEANGYM_COOLTRAINER_F, OPP_JR_TRAINER_F, 1
	object_event  8,  7, SPRITE_SWIMMER_NEW, STAY, LEFT, TEXT_CERULEANGYM_SWIMMER, OPP_SWIMMER, 1
