...
Route14_Object:
	...
	def_object_events
	object_event  4,  4, SPRITE_BIRD_KEEPER_NEW, STAY, DOWN, TEXT_ROUTE14_COOLTRAINER_M1, OPP_BIRD_KEEPER, 14
	object_event 15,  6, SPRITE_BIRD_KEEPER_NEW, STAY, DOWN, TEXT_ROUTE14_COOLTRAINER_M2, OPP_BIRD_KEEPER, 15
	object_event 12, 11, SPRITE_BIRD_KEEPER_NEW, STAY, DOWN, TEXT_ROUTE14_COOLTRAINER_M3, OPP_BIRD_KEEPER, 16
	object_event 14, 15, SPRITE_BIRD_KEEPER_NEW, STAY, UP, TEXT_ROUTE14_COOLTRAINER_M4, OPP_BIRD_KEEPER, 17
	object_event 15, 31, SPRITE_BIRD_KEEPER_NEW, STAY, LEFT, TEXT_ROUTE14_COOLTRAINER_M5, OPP_BIRD_KEEPER, 4
	object_event  6, 49, SPRITE_BIRD_KEEPER_NEW, STAY, UP, TEXT_ROUTE14_COOLTRAINER_M6, OPP_BIRD_KEEPER, 5
