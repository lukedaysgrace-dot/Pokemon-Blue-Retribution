...
Route11_Object:
	...
	object_event 13,  5, SPRITE_YOUNGSTER_NEW, STAY, LEFT, TEXT_ROUTE11_YOUNGSTER1, OPP_YOUNGSTER, 9
	object_event 36, 11, SPRITE_ENGINEER_NEW, STAY, DOWN, TEXT_ROUTE11_SUPER_NERD1, OPP_ENGINEER, 2
	object_event 22,  4, SPRITE_YOUNGSTER_NEW, STAY, UP, TEXT_ROUTE11_YOUNGSTER2, OPP_YOUNGSTER, 10
	...
	object_event 43,  5, SPRITE_YOUNGSTER_NEW, STAY, RIGHT, TEXT_ROUTE11_YOUNGSTER3, OPP_YOUNGSTER, 11
	object_event 45, 16, SPRITE_ENGINEER_NEW, STAY, LEFT, TEXT_ROUTE11_SUPER_NERD2, OPP_ENGINEER, 3
	object_event 22, 12, SPRITE_YOUNGSTER_NEW, STAY, UP, TEXT_ROUTE11_YOUNGSTER4, OPP_YOUNGSTER, 12
