...
Route18_Object:
	...
	def_object_events
	object_event 36, 11, SPRITE_BIRD_KEEPER_NEW, STAY, RIGHT, TEXT_ROUTE18_COOLTRAINER_M1, OPP_BIRD_KEEPER, 8
	object_event 40, 15, SPRITE_BIRD_KEEPER_NEW, STAY, LEFT, TEXT_ROUTE18_COOLTRAINER_M2, OPP_BIRD_KEEPER, 9
	object_event 42, 13, SPRITE_BIRD_KEEPER_NEW, STAY, LEFT, TEXT_ROUTE18_COOLTRAINER_M3, OPP_BIRD_KEEPER, 10
