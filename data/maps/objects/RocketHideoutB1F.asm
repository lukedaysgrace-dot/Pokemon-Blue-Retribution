...
RocketHideoutB1F_Object:
	...
	object_event 12,  6, SPRITE_ROCKET_GIRL, STAY, RIGHT, TEXT_ROCKETHIDEOUTB1F_ROCKET2, OPP_ROCKET_F, 9
	object_event 18, 17, SPRITE_ROCKET, STAY, DOWN, TEXT_ROCKETHIDEOUTB1F_ROCKET3, OPP_ROCKET, 10
	object_event 15, 25, SPRITE_ROCKET_GIRL, STAY, RIGHT, TEXT_ROCKETHIDEOUTB1F_ROCKET4, OPP_ROCKET_F, 11
