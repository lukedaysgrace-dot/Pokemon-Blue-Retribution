...
SSAnne2FRooms_Object:
	...
	object_event 13,  4, SPRITE_FISHER_NEW, STAY, LEFT, TEXT_SSANNE2FROOMS_FISHER, OPP_FISHER, 1
	object_event  0, 14, SPRITE_GENTLEMAN, STAY, RIGHT, TEXT_SSANNE2FROOMS_GENTLEMAN2, OPP_GENTLEMAN, 5
	object_event  2, 11, SPRITE_LASS_NEW, STAY, DOWN, TEXT_SSANNE2FROOMS_COOLTRAINER_F, OPP_LASS, 12
