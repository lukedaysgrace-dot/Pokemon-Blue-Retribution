...
Route19_Object:
	...
	def_object_events
	object_event  8,  7, SPRITE_SWIMMER_NEW, STAY, LEFT, TEXT_ROUTE19_COOLTRAINER_M1, OPP_SWIMMER, 2
	object_event 13,  7, SPRITE_SWIMMER_NEW, STAY, LEFT, TEXT_ROUTE19_COOLTRAINER_M2, OPP_SWIMMER, 3
