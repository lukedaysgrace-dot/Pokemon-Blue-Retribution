...
ViridianForest_Object:
	...
	object_event 30, 33, SPRITE_BUG_CATCHER_NEW, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER2, OPP_BUG_CATCHER, 1
	object_event 30, 19, SPRITE_BUG_CATCHER_NEW, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER3, OPP_BUG_CATCHER, 2
	object_event  2, 18, SPRITE_BUG_CATCHER_NEW, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER4, OPP_BUG_CATCHER, 3
