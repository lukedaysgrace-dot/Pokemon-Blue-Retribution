...
SilphCo3F_Object:
	...
	object_event 20,  7, SPRITE_ROCKET_GIRL, STAY, LEFT, TEXT_SILPHCO3F_ROCKET, OPP_ROCKET_F, 25
	...
	object_event 11, 11, SPRITE_PROTON, STAY, DOWN, TEXT_SILPHCO3F_PROTON
