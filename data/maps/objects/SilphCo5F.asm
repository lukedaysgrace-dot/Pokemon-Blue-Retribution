...
SilphCo5F_Object:
	...
	object_event 18, 10, SPRITE_JUGGLER_NEW, STAY, UP, TEXT_SILPHCO5F_ROCKER, OPP_JUGGLER, 1
	object_event 28,  4, SPRITE_ROCKET_GIRL, STAY, UP, TEXT_SILPHCO5F_ROCKET2, OPP_ROCKET_F, 29
