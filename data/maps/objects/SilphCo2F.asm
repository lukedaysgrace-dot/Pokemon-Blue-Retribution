	...
	const_export SILPHCO2F_TAMER
	const_export SILPHCO2F_JUGGLER
...
SilphCo2F_Object:
	...
	object_event 16, 11, SPRITE_ROCKET_GIRL, STAY, UP, TEXT_SILPHCO2F_ROCKET1, OPP_ROCKET_F, 23
	object_event 24,  7, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO2F_ROCKET2, OPP_ROCKET, 24
	object_event  4,  2, SPRITE_TAMER_NEW, STAY, DOWN, TEXT_SILPHCO2F_TAMER, OPP_TAMER, 6
	object_event 15,  2, SPRITE_JUGGLER_NEW, STAY, NONE, TEXT_SILPHCO2F_JUGGLER, OPP_JUGGLER, 7
