...
ViridianGym_Object:
	...
	object_event 11, 11, SPRITE_BLACKBELT_NEW, STAY, UP, TEXT_VIRIDIANGYM_HIKER1, OPP_BLACKBELT, 6
	object_event 10,  7, SPRITE_TAMER_NEW, STAY, DOWN, TEXT_VIRIDIANGYM_ROCKER1, OPP_TAMER, 3
	object_event  3,  7, SPRITE_BLACKBELT_NEW, STAY, LEFT, TEXT_VIRIDIANGYM_HIKER2, OPP_BLACKBELT, 7
	object_event 13,  5, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_VIRIDIANGYM_COOLTRAINER_M2, OPP_COOLTRAINER_M, 10
	object_event 10,  1, SPRITE_BLACKBELT_NEW, STAY, DOWN, TEXT_VIRIDIANGYM_HIKER3, OPP_BLACKBELT, 8
	object_event  2, 16, SPRITE_TAMER_NEW, STAY, RIGHT, TEXT_VIRIDIANGYM_ROCKER2, OPP_TAMER, 4
