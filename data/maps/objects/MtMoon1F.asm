	...
	const_export MTMOON1F_ARMOR_FOSSIL
	const_export MTMOON1F_ROOT_FOSSIL
...
MtMoon1F_Object:
	...
	def_object_events
	object_event  5,  6, SPRITE_HIKER_NEW, STAY, DOWN, TEXT_MTMOON1F_HIKER, OPP_HIKER, 1
	object_event 12, 16, SPRITE_YOUNGSTER_NEW, STAY, RIGHT, TEXT_MTMOON1F_YOUNGSTER1, OPP_YOUNGSTER, 3
	object_event 30,  4, SPRITE_LASS_NEW, STAY, DOWN, TEXT_MTMOON1F_COOLTRAINER_F1, OPP_LASS, 5
	object_event 24, 31, SPRITE_SUPER_NERD_NEW, STAY, UP, TEXT_MTMOON1F_SUPER_NERD, OPP_SUPER_NERD, 1
	object_event 16, 23, SPRITE_LASS_NEW, STAY, DOWN, TEXT_MTMOON1F_COOLTRAINER_F2, OPP_LASS, 6
	object_event  7, 22, SPRITE_BUG_CATCHER_NEW, STAY, DOWN, TEXT_MTMOON1F_YOUNGSTER2, OPP_BUG_CATCHER, 7
	object_event 30, 27, SPRITE_BUG_CATCHER_NEW, STAY, RIGHT, TEXT_MTMOON1F_YOUNGSTER3, OPP_BUG_CATCHER, 8
	...
	object_event 23, 21, SPRITE_FOSSIL, STAY, NONE, TEXT_MTMOON1F_ARMOR_FOSSIL, ARMOR_FOSSIL
	object_event 38, 12, SPRITE_FOSSIL, STAY, NONE, TEXT_MTMOON1F_ROOT_FOSSIL, ROOT_FOSSIL
