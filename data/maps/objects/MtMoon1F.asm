...
MtMoon1F_Object:
	...
	object_event 24, 20, SPRITE_FOSSIL, STAY, NONE, TEXT_MTMOON1F_ARMOR_FOSSIL, ARMOR_FOSSIL
	object_event 35,  3, SPRITE_FOSSIL, STAY, NONE, TEXT_MTMOON1F_ROOT_FOSSIL, ROOT_FOSSIL
