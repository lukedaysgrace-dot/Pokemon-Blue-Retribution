...
SilphCo11F_Object:
	...
	object_event  2, 11, SPRITE_ARIANA, STAY, RIGHT, TEXT_SILPHCO11F_ROCKET1, OPP_ARIANA, 1
	object_event  5, 14, SPRITE_ARCHER, STAY, DOWN, TEXT_SILPHCO11F_ROCKET2, OPP_ARCHER, 1
