...
CeladonGym_Object:
	...
	object_event  2, 11, SPRITE_LASS_NEW, STAY, RIGHT, TEXT_CELADONGYM_COOLTRAINER_F1, OPP_LASS, 17
	object_event  7, 10, SPRITE_BEAUTY_NEW, STAY, LEFT, TEXT_CELADONGYM_BEAUTY1, OPP_BEAUTY, 1
	object_event  9,  5, SPRITE_JR_TRAINER_F_NEW, STAY, DOWN, TEXT_CELADONGYM_COOLTRAINER_F2, OPP_JR_TRAINER_F, 11
	object_event  1,  5, SPRITE_BEAUTY_NEW, STAY, DOWN, TEXT_CELADONGYM_BEAUTY2, OPP_BEAUTY, 2
	object_event  6,  3, SPRITE_LASS_NEW, STAY, DOWN, TEXT_CELADONGYM_COOLTRAINER_F3, OPP_LASS, 18
	object_event  3,  3, SPRITE_BEAUTY_NEW, STAY, DOWN, TEXT_CELADONGYM_BEAUTY3, OPP_BEAUTY, 3
