...
; Characteristics of each move.
	...
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  25, NORMAL,   100, 35
	move COMET_PUNCH,  ATTACK_TWICE_EFFECT,         45, FIGHTING, 100, 25
	...
	move CROSS_CHOP,   NO_ADDITIONAL_EFFECT,       100, FIGHTING,  85, 10
	move RAZOR_WIND,   NO_ADDITIONAL_EFFECT,        85, FLYING,   100, 10
	...
	move CRUNCH,        DEFENSE_DOWN_SIDE_EFFECT,    80, DARK,     100, 20
	...
	move SUCKER_PUNCH, NO_ADDITIONAL_EFFECT,        40, DARK,      100, 20
	move SLUDGE_BOMB,   POISON_SIDE_EFFECT2,        95, POISON,    100, 15
	...
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  17, BUG,      100, 30
	...
	move DISABLE,      DISABLE_EFFECT,               0, NORMAL,    75, 20
	...
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        85, FLYING,   100, 20
	move SUBMISSION,   SPEED_DOWN_SIDE_EFFECT,      80, FIGHTING,  100, 25
	...
	move SOLARBEAM,    NO_ADDITIONAL_EFFECT,        100, GRASS,   100, 10
	...
	move DIG,          NO_ADDITIONAL_EFFECT,              80, GROUND,   100, 10
	...
	move QUICK_ATTACK, NO_ADDITIONAL_EFFECT,        50, NORMAL,   100, 30
	...
	move EGG_BOMB,     BURN_SIDE_EFFECT1,          100, GRASS,    100, 15
	...
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  35,    ICE,   100, 15
	move CONSTRICT,    SPEED_DOWN_SIDE_EFFECT,      15, NORMAL,   100, 35
	...
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,        85, NORMAL,   100, 20
	move SPORE,        SLEEP_EFFECT,                 0, GRASS,    100, 15
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, NORMAL,    70, 20
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC_TYPE,   80, 15
	move IRON_TAIL,    DEFENSE_DOWN_SIDE_EFFECT,   100, STEEL,     85, 15
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, POISON,   100, 40
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,       140, WATER,     100, 10
	move EXPLOSION,    EXPLODE_EFFECT,             250, NORMAL,   100,  5
	move FURY_SWIPES,  TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,    100, 15
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         60, GROUND,    100, 20
	move REST,         HEAL_EFFECT,                  0, PSYCHIC_TYPE,  100, 10
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,         75, ROCK,      100, 10
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,    90, 15
	move METAL_CLAW,   ATTACK_UP_SIDE_EFFECT,       70, STEEL,    100, 20
	move STEEL_WING,   NO_ADDITIONAL_EFFECT,        70, STEEL,    100, 20
	move TRI_ATTACK,   BURN_SIDE_EFFECT1,           85, NORMAL,   100, 10
	...
	move POWDER_SNOW,  SPEED_DOWN_SIDE_EFFECT2,     40, ICE,      100, 20
	move ICE_SHARD,    NO_ADDITIONAL_EFFECT,        40, ICE,      100, 15
	move EXTREME_SPEED, NO_ADDITIONAL_EFFECT,       80, NORMAL,   100, 10
	move BUG_BITE,     FLINCH_SIDE_EFFECT1,         50, BUG,      100, 15
	move X_SCISSOR,    NO_ADDITIONAL_EFFECT,        80, BUG,      100, 20
	move DRAGON_CLAW,  ATTACK_UP_SIDE_EFFECT,       80, DRAGON,   100, 15
