...
; Characteristics of each move.
	...
	move SHADOW_BALL,  SPECIAL_DOWN_SIDE_EFFECT,    85, GHOST,     100, 15
	...
	move BLAST_BURN,   NO_ADDITIONAL_EFFECT,       150, FIRE,      90,  5
	move HYDRO_CANNON, NO_ADDITIONAL_EFFECT,       150, WATER,     90,  5
